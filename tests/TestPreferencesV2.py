...
class TestPreferencesV2(ProjectTestBase):
    """
    ...
    def testGitHubURLOption(self):
        ...
        self.assertEqual(expectedOption, actualOption, 'Option not correct set')
    ...
    def testTodoistAPIToken(self):
        ...
        expectedValue: str = 'BradonElPendejo'
...
def suite() -> TestSuite:
    ...
    testSuite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(testCaseClass=TestPreferencesV2))
