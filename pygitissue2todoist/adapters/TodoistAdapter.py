...
class TodoistAdapter(AbstractTodoistAdapter):
    """
    This adapter does not have a hard coded assumptions about hierarchy of talks and projects within Todoist.
    It allows the hierarchy to be determined dynamically within `get_hierarchy` method, which is ultimately
    comes from user preferences and settings.
    """
    ...
    def _describe_hierarchy(self, task_info: TodoistTaskInfo, clone_info: CloneInformation):
        ...
        The hierarchy will be determined by mode (e.g. single project or multiple projects
        and milestone-oriented or assigned-issues)
    ...
    def _find_subtasks_from_parent(self, project_id: str, parent_id: str) -> Tasks:
        """
